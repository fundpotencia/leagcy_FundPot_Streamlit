...
class StudentInfoApp:
    ...
    def head(self):
        ...
        """
        st.set_page_config(page_title="Opção 1", page_icon="1️⃣")
        ...
        st.markdown("<h1 style='text-align: center; font-size: 30px;'>✅ Opção 1 - Banco de dados: Alunos</h1>", unsafe_allow_html=True)
        st.markdown(""" <div style="text-align: center; font-size: 20px;"> Nessa página, é possível editar o banco de dados referente à algumas informações pessoais dos alunos como por exemplo: <strong> gênero, LinkedIn, biografia do LinkedIn... </div>""", unsafe_allow_html=True)        
